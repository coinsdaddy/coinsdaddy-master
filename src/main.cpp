...
unsigned int nTargetSpacing = 2 * 30;
unsigned int nStakeMinAge = 60 * 60 * 2;
  ...
  if(pindexBest->nHeight+1 >= 1 && pindexBest->nHeight+1 <= 1)
{
  ...
  else if(pindexBest->nHeight+1 >= 2 && pindexBest->nHeight+1 <= 999999999)
{
  nSubsidy = 0 * COIN;
}
...
// coinsdaddy: attempt to generate suitable proof-of-stake
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "CoinsDaddy 2017 Cryptocurrency";
        CTransaction txNew;
        txNew.nTime = 1497702949;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x8e55a0e1af1889461de3e8e3b0e9b4ee3e7dc3c8d9144ab2b5e80678eb4558b4"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf2, 0x1d, 0xa4, 0xf5 };
